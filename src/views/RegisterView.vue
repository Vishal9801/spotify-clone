...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (error.code === 'auth/email-already-in-use') {
      errors.value.auth = 'This email is already registered';
    } else {
...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#121212] via-[#0D0D0D] to-[#070707] px-4 py-10">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        ...
        <div class="flex items-center">
          ...
          <label for="agree-terms" class="ml-2 block text-sm text-gray-400">
            I agree to the 
            <a href="#" class="text-[#1BD760] hover:underline">Terms of Service</a>
            and
            <a href="#" class="text-[#1BD760] hover:underline">Privacy Policy</a>
          </label>
        </div>
        <p v-if="errors.agreeToTerms" class="text-red-400 text-xs mt-1">{{ errors.agreeToTerms }}</p>
